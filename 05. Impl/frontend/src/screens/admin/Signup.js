        ...
        >
          ...
          >
            ...
            <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('Dashboard')}>
              <Ionicons name="arrow-back-circle-outline" size={40} color="#000000" />
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  background: {
    ...
    backgroundColor: '#fff', // Added background color for header area, adjust as needed
  },
  keyboardAvoidingView: {
    flex: 1,
  },
